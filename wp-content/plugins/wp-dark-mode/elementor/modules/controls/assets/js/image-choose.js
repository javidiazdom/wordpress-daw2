    ...
    var e = elementor.modules.controls.BaseData,
        t = e.extend({
                ...
                onMouseOverLabel: function (e) {
                    var t = this.$(e.currentTarget), o = jQuery(window).height(), n = t.offset(), i = o / 2,
                        r = t.find(".imagelarge"), a = {left: n.left + t.width(), top: 0};
                    n.top <= i ? (r.removeClass("preview-top"), a.top = n.top + t.height() + 17) : (r.addClass("preview-top"), a.top = n.top - 7), r.css(a)
                },

                onMouseDownLabel: function (e) {
                    var t = this.$(e.currentTarget), o = this.$("#" + t.attr("for"));
