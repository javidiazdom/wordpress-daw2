...
<div class="wapf-field__setting" data-setting="<?php echo $model['id']; ?>">
    ...
    <div class="wapf-setting__input">
        ...
        <div style="text-align: right;width: 100%">
	        <?php \SW_WAPF\Includes\Classes\Html::help_modal(__("<p>please note the pricing option in the free version has some limitations:</p><ul style='list-style: disc;margin-left:30px;'><li>Add-on pricing is not quantity-based. This means if the user changes the product quantity, the price does not multiply, but stays the same.</li><li>You can only use the \"flat fee\" option.</li></ul><p><a target=\"_blank\" href=\"https://www.studiowombat.com/knowledge-base/all-pricing-options-explained/?ref=wapf_lite\">See which other pricing options</a> are available in the premium verion.</p>",'advanced-product-fields-for-woocommerce'), __('Important note about pricing','advanced-product-fields-for-woocommerce'), __('Important note about pricing','advanced-product-fields-for-woocommerce')); ?>
        </div>
    </div>
</div>